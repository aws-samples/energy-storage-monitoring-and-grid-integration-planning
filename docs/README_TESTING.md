...
- ![Fig 50](../image/Cleanup/204.png)

- Click on **start execution**

- ![Fig 50](../image/Cleanup/203.png)

- Now you can check data in OpenSearch and backed-up data in s3 firehose-output-bucket, with 2 to 3 minute

- Run this "GET /_search" command to check upcoming data in OpenSearch under DevTool

- ![Fig 50](../image/Cleanup/205.png)
